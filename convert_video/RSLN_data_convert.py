...
import cv2
#讀檔建立資料夾
mp4_files = glob(os.path.join(r"D:/Medical_Imaging_Project/RSLN_45/video", "*.mp4"))
path = "D:/Medical_Imaging_Project/RSLN_45/RSLN_video_data_{}"#資夾名稱
#D:\Medical_Imaging_Project\RSLN_45\video
i=0#計算資料夾編號
print(len(mp4_files))
