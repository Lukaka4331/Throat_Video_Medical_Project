...
#讀檔建立資料夾
jpg_files = glob(os.path.join(r"D:/Medical_Imaging_Project/match_data/RLN_data/orginal/RLN_data_178_M_L_1926684", "*.jpg"))
path = "D:/Medical_Imaging_Project/match_data/RLN_data/RLN_data_178_M_L_1926684"#資夾名稱
os.mkdir(path)
#去除條紋-remove_stripe
